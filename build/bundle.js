	...
	_createClass(ProgressBar, [{
		...
		value: function componentDidMount() {
			...
			var intervalId = setInterval(function () {
				console.log(_this2.state.progress);
...
},{"react":28,"react-dom":25}],2:[function(require,module,exports){
'use strict';
...
var App = function (_React$Component) {
	...
	function App() {
		...
		_this.state = { numero: 3 };
		_this.itsFunction = _this.itsFunction.bind(_this);
		return _this;
	}

	_createClass(App, [{
		key: 'itsFunction',
		value: function itsFunction() {
			// alert('hola');
			console.log(this);
...
},{"./ProgressBar.js":1,"react":28,"react-dom":25}],3:[function(require,module,exports){
(function (process){
'use strict';
